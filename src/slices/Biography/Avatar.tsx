...
export default function Avatar({image, className}: AvatarProps){
        ...
        let ctx = gsap.context(() => {
            ...
            window.onmousemove = (e) => {
                ...
                }).to(".avatar",
                {
                    ...
                    duration: .5,
                }, 0 // position parameter, where to specifically start at
                ).to(".highlight",
                {
    ...
    return(
        <div ref={component} className={clsx("relative h-full w-full", className)}>
            <div className="avatar aspect-rectangle overflow-hidden rounded-3xl border-2 border-slate-700 opacity-0">
                <PrismicNextImage 
                    field={image} 
